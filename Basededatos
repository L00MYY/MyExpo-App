...
CREATE TABLE `profesores` (
  ...
  `clave_profesor` VARCHAR(120) NOT NULL,
...
CREATE TABLE `alumnos` (
  ...
  `clave_alumno` VARCHAR(120) NOT NULL,
...
-- Seleccionar todos los registros de la tabla `nivel_academico`
...
-- Seleccionar todos los registros de la tabla `archivo_adjunto`
...
-- Seleccionar todos los registros de la tabla `dt_curso`
SELECT * FROM dt_curso;

-- Seleccionar todos los registros de la tabla `equipo_expo`
SELECT * FROM equipo_expo;